...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/plugins/css/ace-skins.min.css" />
    ...
    <script src="${pageContext.request.contextPath}/plugins/js/ace-extra.min.js"></script>
...
<%--<jsp:include page="${pageContext.request.contextPath}/pager/top.jsp"/>
<jsp:include page="${pageContext.request.contextPath}/pager/menu.jsp"/>
<jsp:include page="${pageContext.request.contextPath}/pager/index.jsp"/>--%>
...
<script src="${pageContext.request.contextPath}/plugins/js/typeahead-bs2.min.js"></script>

<!-- page specific plugin scripts -->

<!--[if lte IE 8]>
<script src="${pageContext.request.contextPath}/plugins/js/excanvas.min.js"></script>
<![endif]-->

<script src="${pageContext.request.contextPath}/plugins/js/jquery-ui-1.10.3.custom.min.js"></script>
<script src="${pageContext.request.contextPath}/plugins/js/jquery.ui.touch-punch.min.js"></script>
<script src="${pageContext.request.contextPath}/plugins/js/jquery.slimscroll.min.js"></script>
<script src="${pageContext.request.contextPath}/plugins/js/jquery.easy-pie-chart.min.js"></script>
<script src="${pageContext.request.contextPath}/plugins/js/jquery.sparkline.min.js"></script>
<%--<script src="${pageContext.request.contextPath}/plugins/js/flot/jquery.flot.min.js"></script>--%>
<%--<script src="${pageContext.request.contextPath}/plugins/js/flot/jquery.flot.pie.min.js"></script>
<script src="${pageContext.request.contextPath}/plugins/js/flot/jquery.flot.resize.min.js"></script>--%>
